...
#ifndef SMALLWORLD_SORCERES_H
#define SMALLWORLD_SORCERES_H


#include "RaceBanner.h"

class Sorceres : public RaceBanner{
public:
    Sorceres();

    ~Sorceres() override;

    Sorceres(const std::string &raceName_, const std::string &racePowerDescription_, int tokenAmount_);
